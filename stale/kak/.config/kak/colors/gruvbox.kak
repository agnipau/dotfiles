...
set-face global variable "%opt{gruvbox_fg0}"
...
# Builtins.
set-face global Default "%opt{gruvbox_fg4},%opt{gruvbox_bg0_h}"
...
set-face global Information "%opt{gruvbox_fg1},%opt{gruvbox_bg1}"
...
set-face global WrapMarker "%opt{gruvbox_gray}"
