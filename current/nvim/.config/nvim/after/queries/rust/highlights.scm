...
((identifier) @constant (#vim-match? @constant "^[A-Z][A-Z\\d_]+$'"))
...
(call_expression function: (scoped_identifier (identifier) @function .))
...
([(identifier) (field_identifier)] @constant (#match? @constant "^[A-Z]"))
...
(call_expression
 function: (scoped_identifier "::" name: (identifier) @constant)
 (#match? @constant "^[A-Z]"))
