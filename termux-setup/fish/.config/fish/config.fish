...
if test $PREFIX
  ...
  set -x PATH                 $HOME/altro $HOME/progetti/bin $HOME/progetti/pybin $PATH
  ...
  set -x PATH                 /home/matte/altro /home/matte/progetti/pybin /home/matte/progetti/bin $PATH
...
. $HOME/progetti/themes/sh/material-darker.fish
